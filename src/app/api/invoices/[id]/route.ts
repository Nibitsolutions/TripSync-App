    ...
    if (Array.isArray(line_items)) {
      ...
      for (const li of line_items) {
        ...
        await InvoiceLineItem.create({
          ...
          conjunction_city: li.conjunction_city || "",
          ...
          customer_remarks: li.customer_remarks || "",
          our_xo: li.our_xo || "",
          ...
          tax_ced: parseFloat(li.tax_ced) || 0,
          tax_gst_dom: parseFloat(li.tax_gst_dom) || 0,
          tax_ast: parseFloat(li.tax_ast) || 0,
          ...
          discount2_percent: parseFloat(li.discount2_percent) || 0,
          discount2_amount: parseFloat(li.discount2_amount) || 0,
          psf_p_percent: parseFloat(li.psf_p_percent) || 0,
          psf_p_amount: parseFloat(li.psf_p_amount) || 0,
